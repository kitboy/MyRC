...
function! PdbMapKeyboard()
	...
	map <buffer> <silent> <F6> :call PdbToggleBreakpointOnCurrentLine()<CR>
	map <buffer> <silent> <C-F6> :call PdbToggleConditionalBreakpointOnCurrentLine()<CR>
	map <buffer> <silent> <S-F6> :call PdbToggleTemporaryBreakpointOnCurrentLine()<CR>
	map <buffer> <silent> <C-S-F6> :call PdbClearAllBreakpointsInCurrentFile()<CR>
	map <buffer> <silent> <LocalLeader>bc :call PdbClearAllBreakpoints()<CR>
	map <buffer> <silent> <LocalLeader>bl :call PdbLoadSavedBreakpoints()<CR>
	map <buffer> <silent> <LocalLeader>bs :call PdbSaveSavedBreakpoints()<CR>
	map <buffer> <silent> <LocalLeader>bp :call PdbPrintBreakpointConditionOnCurrentLine()<CR>
	...
	map <buffer> <silent> <F9> :call PdbSetFocusToCurrentDebugLine()<CR>
	map <buffer> <silent> <C-F9> :call PdbJumpToCurrentLine()<CR>

	map <buffer> <silent> <LocalLeader>su :call PdbMoveUpInStackFrame()<CR>
	map <buffer> <silent> <LocalLeader>sd :call PdbMoveDownInStackFrame()<CR>
	map <buffer> <silent> <LocalLeader>sp :call PdbPrintStackTrace()<CR>

	map <buffer> <silent> <LocalLeader>ew :call PdbEvalCurrentWord()<CR>
	map <buffer> <silent> <LocalLeader>eW :call PdbEvalCurrentWORD()<CR>
	map <buffer> <silent> <LocalLeader>ep :call PdbEvalExpression()<CR>
	map <buffer> <silent> <LocalLeader>eP :call PdbExecStatement()<CR>
